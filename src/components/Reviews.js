    ...
    return (
        ...
        <div class="card2">
            <div class="card2-info">
                ...
                <div class="card2-title">Person1</div>
                <div class="card2-subtitle">Coach Team 1</div>
                <div class="card2-subtitle">"Rewiew of the application number 1"</div>
        ...
        <div class="card2">
            <div class="card2-info">
                <div class="card2-avatar"></div>
                <div class="card2-title">Person2</div>
                <div class="card2-subtitle">Coach team 2</div>
                <div class="card2-subtitle">"Rewiew of the application number 2"</div>
        ...
        <div class="card2">
            <div class="card2-info">
                <div class="card2-avatar"></div>
                <div class="card2-title">Person3</div>
                <div class="card2-subtitle">Coach team 3</div>
