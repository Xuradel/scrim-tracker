...
const QuickFeatures2 = () => {
    ...
    return (
        <div className="features2-section">
            {!isMobile ? <div className="features2" >
                <div className="features2-text" data-aos="fade-right">
                ...
                <div className="features2-img-section" data-aos="zoom-in">
                    <img src={require("../images/matchups.jpeg")} className="features2-img"></img>
                </div>
            </div> : <div className="features2" >
            ...
            {!isMobile ? <div className="features2-2" >
                <div className="features2-text" data-aos="fade-left">
