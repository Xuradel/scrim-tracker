    ...
    return (
        <div className="features-1" id="features-section">
            <div className="features1-item">
                <div className="features1-inside" data-aos="fade-in">
                    <img src={require("../images/depth.png")} className="features1-icon"></img>
                    <h2>IN DEPTH <span className="gold">TRACKING</span></h2>
                </div>
                <p data-aos="fade-out">Track every second of data, starting from lobby, champion selection, in-game
            ...
            <div className="features1-item">
                ...
                <p data-aos="fade-out">Analyze every move and data recorded by our application every second.
            ...
            <div className="features1-item">
                ...
                <p data-aos="fade-out">Our data is reliable since it uses League's API and our code process
